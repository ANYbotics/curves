...
RosMultiDOFJointTrajectoryTranslationInterface::RosMultiDOFJointTrajectoryTranslationInterface() : PolynomialSplineQuinticVector3Curve() {}

RosMultiDOFJointTrajectoryTranslationInterface::~RosMultiDOFJointTrajectoryTranslationInterface() {}

bool RosMultiDOFJointTrajectoryTranslationInterface::fromMessage(const trajectory_msgs::MultiDOFJointTrajectory& message,
  ...
  for (const auto& point : message.points) {  // TODO Make nicer with ROS to kindr transforms.
    ...
    PolynomialSplineQuinticVector3Curve::ValueType position(point.transforms[j].translation.x, point.transforms[j].translation.y,
